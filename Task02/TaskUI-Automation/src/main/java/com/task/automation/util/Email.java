	...
	public static void sendEmail() {
		...
		Session session = Session.getDefaultInstance(props,
				...
				new javax.mail.Authenticator() {
					...
					return new PasswordAuthentication("sidharth.shukla19@gmail.com", "shirdi678");
		...
		try {
			...
			message.setRecipients(Message.RecipientType.TO,InternetAddress.parse("sidhartha.shukla19@gmail.com"));
            
                        // Add the subject link
			message.setSubject("Automation_Execution_Status:Task");
			...
			String filename = System.getProperty("user.dir")+"/results/"+ BaseTestCase.TimeStamp+" IxOnespace_Automation.html";
